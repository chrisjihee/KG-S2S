...
if __name__ == '__main__':
    ...
    parser.add_argument('-precision', type=str, default='16', help='Floating point precision')
    ...
    parser.add_argument('-epoch', dest='epochs', type=int, default=3, help='Number of epochs')
